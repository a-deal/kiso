"""OAuth 2.0 Authorization Code flow for WHOOP.

Usage:
    python3 cli.py auth whoop

Config: whoop.client_id and whoop.client_secret in gateway.yaml.
...
class _OAuthCallbackHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if "code" in params:
            ...
            self.end_headers()
            self.wfile.write(b"<html><body><h2>WHOOP connected!</h2>"
...
def run_auth_flow(
    ...
    print(f"WHOOP tokens saved to {saved_dir}")
